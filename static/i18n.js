(function () {
  const translations = {
    fr: {
      ...
      navFleet: 'Fleet',
      fleetEyebrow: 'Fleet',
      fleetTitle: 'Santé des postes',
      fleetSubtitle: 'Vue centrale des machines reportées par les agents.',
      fleetTableTitle: 'Machines',
      fleetEmptyTitle: 'Aucune machine reportée.',
      fleetEmptyHint: 'Déployer un agent qui POST sur /api/fleet/report avec FLEET_TOKEN.',
    },
    en: {
      name: 'English',
      langLabel: 'Language',
      ...
      navFleet: 'Fleet',
      fleetEyebrow: 'Fleet',
      fleetTitle: 'Endpoint health',
      fleetSubtitle: 'Central view of machines reported by agents.',
      fleetTableTitle: 'Machines',
      fleetEmptyTitle: 'No machines reported.',
      fleetEmptyHint: 'Deploy an agent posting to /api/fleet/report with FLEET_TOKEN.',
    },
    es: {
      name: 'Español',
      langLabel: 'Idioma',
      ...
      navFleet: 'Fleet',
      fleetEyebrow: 'Fleet',
      fleetTitle: 'Salud de los equipos',
      fleetSubtitle: 'Vista central de máquinas reportadas por agentes.',
      fleetTableTitle: 'Equipos',
      fleetEmptyTitle: 'Ninguna máquina reportada.',
      fleetEmptyHint: 'Despliega un agente que haga POST a /api/fleet/report con FLEET_TOKEN.',
    },
    ru: {
      name: 'Русский',
      langLabel: 'Язык',
      ...
      navFleet: 'Флот',
      fleetEyebrow: 'Флот',
      fleetTitle: 'Состояние машин',
      fleetSubtitle: 'Центральный обзор машин от агентов.',
      fleetTableTitle: 'Машины',
      fleetEmptyTitle: 'Нет данных о машинах.',
      fleetEmptyHint: 'Разверните агент с POST на /api/fleet/report с FLEET_TOKEN.',
    },
  };
